...
from sampler import ResShiftSampler ,RESSampler
...
def get_configs(args):
    ...
    if args.task == 'realsr':
        ...
        configs = OmegaConf.load('./configs/bicx4resdif_swinunet_lpips.yaml')
        assert args.scale == 4, 'We only support the 4x super-resolution now!'
        ckpt_url = _LINK[args.task]
        ckpt_path =r"D:\dataset\weights\dif\0.50.999\model_85000.pth"#"/ai/BasicSR-gnn/resdif/expriments/2024-07-03-23-57/ckpts/model_12000.pth"#"/ai/BasicSR-gnn/resdif/weights/model_50000.pth"
